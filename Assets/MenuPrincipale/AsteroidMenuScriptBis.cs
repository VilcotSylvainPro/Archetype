...
public class AsteroidMenuScriptBis : MonoBehaviour
{
    ...
    void Start()
    {
            ...
            Vector3 FuseePostion = new Vector3(Random.Range(-300,300), 800, Random.Range(-400, 400));
    ...
    void Update()
    {
       Vector3 Test = Vector3.MoveTowards(transform.position, targetPosition, Vitesse * Time.deltaTime);
        transform.position = new Vector3(Test.x, 800, Test.z);
